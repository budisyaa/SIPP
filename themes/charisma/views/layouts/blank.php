...
<head>
    ...
    <!-- The styles -->
    <link id="bs-css" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/bootstrap-cerulean.min.css" rel="<?php echo Yii::app()->theme->baseUrl; ?>/stylesheet">
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
                <!-- put your content here --><?php echo $content; ?>
            </div>
        </div>
    </div>
</div><!--/row-->
