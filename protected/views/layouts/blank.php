...
<body>
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="<?php echo Yii::app()->theme->baseUrl; ?>/index.html"> <img alt="Charisma Logo" src="<?php echo Yii::app()->theme->baseUrl; ?>/img/logo20.png" class="hidden-xs"/>
